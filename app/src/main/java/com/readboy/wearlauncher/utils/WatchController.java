...
public class WatchController extends BroadcastReceiver {
    ...
    private ArrayList<DateChangedCallback> mDateChangedCallback = new ArrayList<DateChangedCallback>();
    ...
    private ArrayList<StepChangedCallback> mStepChangedCallback = new ArrayList<StepChangedCallback>();
    ...
    private ArrayList<CallUnreadChangedCallback> mCallUnreadChangedCallback = new ArrayList<CallUnreadChangedCallback>();
    ...
    private ArrayList<WeTalkUnreadChangedCallback> mWeTalkUnreadChangedCallback = new ArrayList<WeTalkUnreadChangedCallback>();
    ...
    private ArrayList<ClassDisableChangedCallback> mClassDisableChangedCallback = new ArrayList<ClassDisableChangedCallback>();
